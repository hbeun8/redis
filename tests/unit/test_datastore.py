...
def test_dict_base_case():
    data = {"foo": "bar", "Expiry": "1753980862400517000", "type": "123"}
    c = Dict(data)
    result_key = c.key
    ...
    assert result_expiry == "1753980862400517000"
    assert result_type == "123"
    assert result_s == "bar:25/07/25:123"
    assert result_u_s == {"foo": "bar", "Expiry": "1753980862400517000", "type": "123"}
...
def test_datastore_getter_setter():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    set_result = c.Add("Name", "Varun:1753980862400517000:123")
    get_result = c.Get("Name")
    assert set_result == "+OK"
    assert get_result == "Varun:1753980862400517000:123"
...
def test_datastore_add_base_case():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    result = c.Add("Name", "Varun:1753980862400517000:123")
    assert result == "+OK"
...
def test_datastore_get_base_cases():
    ...
    c = Datastore(data)
    result = c.Add("Name", "Varun:1753980862400517000")
    result = c.Get("Name")
    assert result == "Varun:1753980862400517000:123"
...
def test_datastore_remove_base_case():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    c.Add("Name", "Varun:1753980862400517000:123")
...
def test_datastore_incr_invalid_literal():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    c.Add("k", "[1, 2, 3]:1753980862400517000:123")
    result = c.incr("k")
    assert result == "(error) ERR value is not an integer or out of range"


def test_datastore_get_expiry_is_none():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    c.Add("k", "[1, 2, 3]:None:123")
    result = c.Get("k")
    assert result == "1,2,3"

def test_datastore_get_expiry_base_case():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    c.Add("k", "1:1753980862400517000:123")
    result = c.Get("k")
    assert result == "(nil)"

def test_datastore_set_new_expiry_seconds_1():
    data = {"Name": "Varun", "Expiry": "1753980862400517000", "Type": 123}
    c = Datastore(data)
    c.Add("Name", "Varun:1753980862400517000:123")
    result = c.set_new_expiry_px_ex("Name", "Ki", "PX", 60)
    value = c.Get("Name")
    assert result == "+OK"
    assert value == 60